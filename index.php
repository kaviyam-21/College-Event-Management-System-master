        ...
        <div class = "content"><!--body content holder-->
            <div class = "container">
                <div class = "col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1 style="color:color: #FFFFFF; font-size:42px ; font-style:bold "><strong> Unlock the Fun – Register for Your Favorite Events! </strong></h1><!--body content title-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <h1 style="color:#9C9F63 ; font-size:38px ;" ><strong>Technical Events</strong></h1><!--title-->
                            <p><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#9C9F63 ; font-size:38px ;"><strong>Gaming Events</strong></h1><!--title-->
                            <p><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#9C9F63 ; font-size:38px ;"><strong>On-Stage Events</strong></h1><!--title-->
                            <p><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#9C9F63 ; font-size:38px ;"><strong>Off-Stage Events</strong></h1><!--title-->
                            <p><!--content-->
